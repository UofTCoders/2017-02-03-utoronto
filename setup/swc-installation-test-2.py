...
class DependencyError (Exception):
    ...
    _setup_urls = {  # (system, version, package) glob pairs
        ...
        ('Linux', '*', 'chromium'): 'https://chromium.googlesource.com/chromium/src/+/master/docs/linux_build_instructions.md',
        ('Darwin', '*', 'chromium'): 'https://chromium.googlesource.com/chromium/src/+/master/docs/mac_build_instructions.md',
        ('Windows', '*', 'chromium'): 'https://chromium.googlesource.com/chromium/src/+/master/docs/windows_build_instructions.md',
        ...
        ('*', '*', 'nose'): 'https://nose.readthedocs.io/en/latest/#installation-and-quick-start',
        ('*', '*', 'nosetests'): 'https://nose.readthedocs.io/en/latest/#installation-and-quick-start',
        ...
        ('Linux', '*', 'scipy'): 'https://www.scipy.org/install.html#install-systemwide-via-a-linux-package-manager',
        ('Darwin', '*', 'scipy'): 'https://www.scipy.org/install.html#install-systemwide-via-a-mac-package-manager',
        ('Windows', '*', 'scipy'): 'https://www.scipy.org/install.html#windows-packages',
        ...
        ('*', '*', 'xemacs'): 'http://www.xemacs.org/Download/',
